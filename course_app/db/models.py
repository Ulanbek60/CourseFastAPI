...
class Student(Base):
    ...
    answer_students: Mapped[List['AnswerStudent']] = relationship('AnswerStudent', back_populates='student_answer',
                                                        cascade='all, delete-orphan')
    student_certificate: Mapped['Certificate'] = relationship('Certificate', back_populates='certificate_student',
                                                        cascade='all, delete-orphan')
    ...
    student_review_student: Mapped[List['TeacherReview']] = relationship('TeacherReview', back_populates='student_review',
                                                        cascade='all, delete-orphan')
    cart_user: Mapped['Cart'] = relationship('Cart', back_populates='student_cart',
                                                        cascade='all, delete-orphan', uselist=False)
    favorite_user: Mapped['Favorite'] = relationship('Favorite', back_populates='student_favorite',
                                                        cascade='all, delete-orphan', uselist=False)
...
class RefreshStudentToken(Base):
    __tablename__ = 'refresh_student_teacher'

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    token: Mapped[str] = mapped_column(String, unique=True, index=True)
    created_date: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    user_id: Mapped[int] = mapped_column(ForeignKey('student.id'))
    user: Mapped['Teacher'] = relationship('Student', back_populates='tokens')
