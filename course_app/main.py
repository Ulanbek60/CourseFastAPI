...
from course_app.api.endpoints.favorite import favorite_router
...
<<<<<<< HEAD
from course_app.api.endpoints import (about, answer, assignment, auth, category, certificate, course,
                                      exam, lesson, option, questions, social_auth, student, teacher, teacher_review)
=======
